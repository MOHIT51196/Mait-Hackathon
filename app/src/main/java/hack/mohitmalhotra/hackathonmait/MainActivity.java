...
import hack.mohitmalhotra.hackathonmait.cards.SliderAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final String[] ngos = {"Drishti", "Akshara Center", "BREAD", "EKAM Foundation", "Khushboo Welfare"};
    private final String[] startYear = {"2009", "1999", "2015", "1985", "2002"};
    private final String[] location = {"Chitrakoot, UP    502 KM  away", "Chennai, Tamil Nadu    499 KM  away", "Haryana, Gurgaon    184 KM  away"};
    ...
    private void initSwitchers() {
        ...
        temperatureSwitcher.setCurrentText(startYear[0]);

        placeSwitcher = (TextSwitcher) findViewById(R.id.ts_place);
        placeSwitcher.setFactory(new TextViewFactory(R.style.PlaceTextView, false));
        placeSwitcher.setCurrentText(ngos[0]);

        clockSwitcher = (TextSwitcher) findViewById(R.id.ts_clock);
        clockSwitcher.setFactory(new TextViewFactory(R.style.ClockTextView, false));
        clockSwitcher.setCurrentText(location[0]);
